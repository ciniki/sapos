...
// <rsp stat='ok' id='34' />
//
function ciniki_sapos_templates_quoteDefault(&$ciniki, $business_id, $invoice_id, $business_details, $sapos_settings) {
    //
    ...
    //
    $waddr = array();
    if( ($ciniki['business']['modules']['ciniki.sapos']['flags']&0x020000) > 0 ) {
