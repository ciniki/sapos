...
function ciniki_sapos_qiItemAdd(&$ciniki) {
    ...
    $rc = ciniki_sapos_checkAccess($ciniki, $args['business_id'], 'ciniki.sapos.qiItemAdd'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }
	...
	$rc = ciniki_core_objectAdd($ciniki, $args['business_id'], 'ciniki.sapos.qi_item', $args, 0x07);
	if( $rc['stat'] != 'ok' ) {
