...
function ciniki_sapos_expenseItemUpdate(&$ciniki) {
    ...
    $rc = ciniki_sapos_checkAccess($ciniki, $args['tnid'], 'ciniki.sapos.expenseItemUpdate'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }
    ...
    $rc = ciniki_core_objectUpdate($ciniki, $args['tnid'], 'ciniki.sapos.expense_item', $args['item_id'], $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
