...
// -------
//
function ciniki_sapos_shippingRateUpdate(&$ciniki) {
    //
    ...
    $rc = ciniki_core_prepareArgs($ciniki, 'no', array(
        ...
        'profile_id'=>array('required'=>'no', 'blank'=>'no', 'name'=>'Profile'),
    ...
    $rc = ciniki_sapos_checkAccess($ciniki, $args['tnid'], 'ciniki.sapos.shippingRateUpdate');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    //
    // Update the Shipping Profile Rate in the database
    //
    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'objectUpdate');
    $rc = ciniki_core_objectUpdate($ciniki, $args['tnid'], 'ciniki.sapos.shippingrate', $args['rate_id'], $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
    ...
    ciniki_core_hookExec($ciniki, $args['tnid'], 'ciniki', 'web', 'indexObject', array('object'=>'ciniki.sapos.shippingRate', 'object_id'=>$args['rate_id']));
