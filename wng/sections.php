...
function ciniki_sapos_wng_sections(&$ciniki, $tnid, $args) {
    ...
    if( ciniki_core_checkModuleFlags($ciniki, 'ciniki.sapos', 0x02000000) ) {
        ...
        //
        // Simple Donations Block
        //
        $sections['ciniki.sapos.donationbuttons'] = [
            'name'=>'Donation Buttons',
            'module' => 'Accounting',
            'settings' => [
                'title' => ['label' => 'Title', 'type' => 'text'],
                'content' => ['label' => 'Message', 'type' => 'textarea', 'size'=>'small'],
                'amounts' => ['label' => 'Amounts', 'type' => 'text'],
                'other' => ['label' => 'Other Amount', 'type' => 'toggle', 'default'=>'yes', 'toggles' => [
                    'no' => 'No',
                    'yes' => 'Yes',
                    ]],
                ],
